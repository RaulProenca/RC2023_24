  ...
  function addContact() {
    $("#btn-add").click(function () {
      ...
      $html =
        ...
        '<img src="../assets/images/users/1.jpg" alt="avatar" class="rounded-circle" width="45">' +
        '<div class="ms-3">' +
        ...
        "</td>" +
        "<td>" +
        '<span class="usr-email-addr text-muted" data-email=' +
        $_emailValue +
        ">" +
        $_emailValue +
        "</span>" +
        "</td>" +
        "<td>" +
        '<span class="usr-location text-muted" data-location=' +
        $_locationValue +
        ">" +
        $_locationValue +
        "</span>" +
        "</td>" +
        "<td>" +
        '<span class="usr-ph-no text-muted" data-phone=' +
        $_phoneValue +
        ">" +
        $_phoneValue +
        "</span>" +
