...
class AtletaController extends Controller
{
    ...
    {
        //Mostrar o formulário de edição do atleta
        ...
        //compact('atleta') -> envia a variável $atleta para a view atleta.edit
        return view('atleta.edit', compact('atleta', 'countries'));
