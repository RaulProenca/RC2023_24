                ...
                <div class="form-group">
                  <div class="d-flex">
                    <div class="checkbox checkbox-info pt-0">
                      ...
                      <input class="material-inputs chk-col-indigo" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                    ...
                    <div class="ms-auto">
                          ...
                          align-items-center
                          link
                          font-weight-medium" href="{{ route('password.request') }}">
                          <i class="ri-lock-line me-1 fs-4"></i> {{ __('Forgot Your Password?') }}
                          </a>
                          @endif
                    </div>
                  </div>
