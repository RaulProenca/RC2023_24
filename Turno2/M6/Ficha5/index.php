...
if (isset($_POST["btnAdicionar"])){
    ...
    $matricula = $_GET["edit"];
    $rent = $_SESSION["rent"][$matricula];
    $ndias = $rent->getNdias();
    $marca = $rent->getMarca();
    $segmento = $rent->getSegmento();
    $extras = $rent->getExtras();
    $total = $rent->getTotal();
    $edit = true;
}
else{
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body bg-light">
                <form id="formRentACar" action="" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Utilitário/Sedan"
                                    name="inputSegmento" id="segUtilitario" checked />
                                <label class="form-check-label" for="segUtilitario">Utilitário/Sedan</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Carrinha/Combi (+5€/dia)"
                                    name="inputSegmento" id="segCarrinha" />
                                <label class="form-check-label" for="segCarrinha">Carrinha/Combi (+5€/dia)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="SUV/Monovolume (+10€/dia)"
                                    name="inputSegmento" id="segSuv" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="inputExtras[]"
                                    id="extra_ar_condicionado" value="Ar condicionado" />
                                <label class="form-check-label" for="extra_ar_condicionado">Ar condicionado</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="inputExtras[]" id="extra_gps"
                                    value="GPS" />
                                <label class="form-check-label" for="extra_gps">GPS</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="inputExtras[]"
                                    id="extra_estofos_pele" value="Estofos em pele" />
                                <label class="form-check-label" for="extra_estofos_pele">Estofos em pele</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="inputExtras[]"
                                    id="extra_pintura_metalizada" value="Pintura metalizada" />
                                <label class="form-check-label" for="extra_pintura_metalizada">Pintura
                                    metalizada</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="submit" name="btnAdicionar" id="btnAdicionar" class="btn btn-success"
                                value="Adicionar">
