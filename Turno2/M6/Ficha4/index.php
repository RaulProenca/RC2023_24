    ...
    <div class="container">
        ...
        <form action="" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" value="<?php echo ($edit) ? $nome : "";  ?>" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" value="<?php echo ($edit) ? $morada : "";  ?>" class="form-control"
                        name="inputMorada" id="inputMorada" required>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inputGenero" id="inputGenero1" value="M"
                            <?php echo ($genero == 'Masculino') ? 'checked' : '' ?>>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inputGenero" id="inputGenero2" value="F"
                            <?php echo ($genero == 'Feminino') ? 'checked' : '' ?>>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <input type="submit" class="btn btn-primary" id="btnAdicionar" name="btnAdicionar" value="Adicionar"
                        <?php echo ($edit) ? 'disabled' : ''; ?>>

                    <input type="submit" class="btn btn-warning" id="btnEditar" name="btnEditar" value="Editar"
                        <?php echo (!$edit) ? 'disabled' : ''; ?>>
                </div>
            </div>
